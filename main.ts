...
let mySprite = sprites.create(img`
    ...
    . . . f f f f f f f . . . . . . 
    `, SpriteKind.Player)
game.showLongText("Hello, I'm Lestat the bat.", DialogLayout.Bottom)
game.showLongText("I can move using either WASD or the arrows on your keyboard.", DialogLayout.Bottom)
